...
**Pendiente explícito fuera de ola:** materialización de ejecutables en cápsulas según producto. **Catálogo Core:** [SddIA/tools/index.md](../tools/index.md) ya incluye la primera entidad formal `iota-immutable-publisher` (forja `scope=core`). **CI índices:** workflow `.github/workflows/sddia-index-qa.yml` + `SddIA/scripts/qa/verify-tools-index.py`.
