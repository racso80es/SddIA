...
- **Sincronización:** tres definiciones de acción con identidad atómica; reflejadas en sendas filas del catálogo.
- **Metadatos:** valores de la tabla (incl. **Capabilities**) copiados desde el YAML de `execute-process.md`, `crypto-broker.md` y `policy-validator.md` al momento de indexación.
