...
| route-domain-event | 9b314f74-44d3-43c4-b916-871a9fa43f45 | 1.1.0 | event-routing | Lee padre en eda_bus.pending, fan-out por eda_bus.subscriptions, testigos en subscribers/, padre inmutable hasta sweeper. | `domain-event-routing`, `subscription-registry-lookup`, `subscriber-witness-ledger`, `event-bus-lifecycle-move`, `delegate-filesystem-manager`, `subscriber-fanout-orchestration` |
