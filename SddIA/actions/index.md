...
| emit-pr-merged-event | c0d71f2b-c1c1-4c56-8f74-2f4f41b24c4f | 1.0.0 | dlt-auditing | Sello criptográfico PullRequest_Merged (V2): hash de merge vía git-manager, UUID vía crypto-broker, escritura en `.SddIA/events/pending/`. | `pr-merged-event-emission`, `event-bus-pending-write`, `delegate-git-manager`, `delegate-crypto-broker`, `delegate-filesystem-manager` |
