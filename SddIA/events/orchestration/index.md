...
|----------------|------|------|------------|---------|----------|---------|--------------|
| `fracture-clarification-requested.md` | `7d08d6c4-2ee3-4a70-953f-6f49375913d8` | fracture-clarification-requested | Fracture_Clarification_Requested | 1.0.0 | events-contract v1.1.0 | ecosystem-evolution | `fracture_clarification_requested` |
