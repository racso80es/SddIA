...
inputs:
  - "refactor_goal": "Objetivo estructural (legibilidad, modularización, deuda técnica) sin nueva funcionalidad"
  - "refined_constraints": "Restricciones de compatibilidad y alcance acordadas con Mayeuta cuando aplique"
...
phases:
  - name: "Estabilización de alcance"
    intent: "Fijar límites del refactor y superficies tocadas (Mayeuta cuando el alcance sea ambiguo)."
    delegates_to:
      - "agent:mayeuta"
