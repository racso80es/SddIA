...
- **Sincronización:** siete definiciones de agente con identidad atómica; reflejadas en sendas filas del catálogo.
- **Perfiles cognitivos:** `llm_profile` opcional en YAML (`agents-contract` v1.1.0). Dedalo/Mayeuta `high`; Argos `medium` (síntesis); Tekton `low`; Cerbero/Cúmulo/Radamanto `none`.
