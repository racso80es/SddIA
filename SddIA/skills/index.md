...
- **Sincronización:** dos archivos de definición de skill con identidad atómica; reflejados en sendas filas del catálogo.
- **Metadatos:** valores de la tabla (incl. **Capabilities**) copiados desde el YAML de `filesystem-manager.md` y `cryptography-manager.md` al momento de indexación.
