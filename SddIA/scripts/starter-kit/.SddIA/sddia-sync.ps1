...
<#
  ...
  ZONA SAGRADA — NO TOCAR desde este script:
    ...
    .SddIA/constitution/
    .SddIA/evolution/
  Las definiciones normativas locales del cliente viven bajo `.SddIA/` (tools: evolution c3a9f1b2).
  Este script solo elimina y reclona el árbol "SddIA/" bajo la raíz del repo; cualquier futura
  copia/merge adicional DEBE excluir explícitamente `.SddIA/tools/`, `.SddIA/constitution/` y `.SddIA/evolution/`.
#>
