...
name: Execution
outputs:
  - execution.md en carpeta de tarea (Cúmulo) con YAML Frontmatter; no execution.json separado
...
- **Documento de implementación** (obligatorio): ruta a implementation.md en la carpeta de la tarea (Cúmulo). Contiene los ítems con Id, Acción, Ruta, Ubicación, Propuesta y Dependencias (en contenido MD y/o frontmatter).
...
4. **Persistencia:** Escribir execution.md en la carpeta de la tarea (Cúmulo) con YAML Frontmatter y el registro completo.
...
- **Arquitecto / QA Judge:** Pueden revisar `execution.md` para comprobar que todos los ítems se aplicaron y que no hubo desviaciones respecto al IMPL.
