...
- **Proceso:** definido en paths.processPath (feature, bug-fix, tool-creator, etc.). Los procesos invocan acciones y skills; la IA sigue el proceso en lugar de lanzar comandos por su cuenta.
