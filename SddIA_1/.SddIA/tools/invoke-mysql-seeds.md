...
Implementación local: **`scripts/tools/invoke-mysql-seeds/`** (binario, script o orquestador acordado por el workspace). Sin rutas normativas de plataforma en el Core.
