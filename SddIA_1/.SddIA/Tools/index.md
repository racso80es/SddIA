...
Definiciones en este árbol; la **implementación (delivery)** debe residir bajo `.SddIA/tool-capsules/<tool-id>/`, resuelto vía `implementation_path_ref` en cada `spec.json`.
