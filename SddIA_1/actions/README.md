...
| finalize-process | Cierre de proceso/tarea (commits, Evolution Logs, sync remoto y PR). Git S+: git-sync-remote + git-create-pr. | paths.actionsPath/finalize-process/ |
