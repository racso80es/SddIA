...
| Check | Resultado |
|-------|-----------|
| `revoked.accept-pr` | **ausente** (was since `2026-08-28T18:21:13Z`) |
...
Cascada + evolution `d4f8e2a1-6c39-4b7e-9a05-1f3c8d7e6b20`. Assert: **no** `.SddIA/cerbero/` ni `.SddIA/radamanto/` en diff PR.
