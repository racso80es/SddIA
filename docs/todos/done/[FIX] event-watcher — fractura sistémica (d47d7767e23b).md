...
document_id: PBI-FIX-FRACTURE-d47d7767e23b
...
fracture_hash: d47d7767e23b
incident_ref: "System_Fracture_Detected — d47d7767e23b"
related:
...
```
Centinela event-watcher omitió 27 ciclos consecutivos de Daemon_Heartbeat (umbral=3). last_heartbeat=2026-08-11T07:32:03Z
```
