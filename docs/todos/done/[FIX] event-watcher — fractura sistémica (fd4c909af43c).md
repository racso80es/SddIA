...
document_id: PBI-FIX-FRACTURE-fd4c909af43c
...
fracture_hash: fd4c909af43c
incident_ref: "System_Fracture_Detected — fd4c909af43c"
related:
...
```
Centinela event-watcher omitió 7 ciclos consecutivos de Daemon_Heartbeat (umbral=3). last_heartbeat=2026-07-13T18:08:46Z
```
