...
document_id: PBI-FIX-FRACTURE-199a6a39f84e
...
fracture_hash: 199a6a39f84e
incident_ref: "System_Fracture_Detected — 199a6a39f84e"
related:
...
```
Centinela event-watcher omitió 66716 ciclos consecutivos de Daemon_Heartbeat (umbral=3). last_heartbeat=2026-06-20T14:10:21Z
```
