...
feature_ref: docs/features/ppr-revoked-registry-rehab-ppr190
...
| **#190 (este PBI)** | Kaizen Paciente 0 redeploy | permanent · `max_recovery_attempts_exceeded` + revoked · `abrupt_success_rate_drop` | `16:25:55Z` / `17:24:18Z` | **done** |
...
| Sighting | CID | Nota |
|----------|-----|------|
| Cosecha PR #194 | `59606407-eed3-4da8-ac13-3cf6205b2147` | `@ 2026-08-26T11:48:00Z` · bundle-consumer-telegram-gateway · 0 create · affirm #190 · Cerbero permanent+revoked OK · accept_pr_handoff true |
...
- [x] Laudo rehabilitación Cerbero / Radamanto (anti-recurrencia `abrupt_success_rate_drop` + `max_recovery_attempts_exceeded`)
- [x] `pull-request-review` ausente de `permanent` y `revoked` en `revoked_entities.json`
