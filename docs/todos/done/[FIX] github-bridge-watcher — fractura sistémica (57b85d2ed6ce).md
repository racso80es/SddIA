...
document_id: PBI-FIX-FRACTURE-57b85d2ed6ce
...
fracture_hash: 57b85d2ed6ce
incident_ref: "System_Fracture_Detected — 57b85d2ed6ce"
related:
...
```
Centinela github-bridge-watcher omitió 3 ciclos consecutivos de Daemon_Heartbeat (umbral=3). last_heartbeat=2026-06-16T08:36:33Z
```
