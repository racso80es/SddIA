...
document_id: PBI-FIX-FRACTURE-257a17f9cd13
...
fracture_hash: 257a17f9cd13
incident_ref: "System_Fracture_Detected — 257a17f9cd13"
related:
...
```
Centinela event-watcher omitió 3971 ciclos consecutivos de Daemon_Heartbeat (umbral=3). last_heartbeat=2026-07-15T06:28:43Z
```
