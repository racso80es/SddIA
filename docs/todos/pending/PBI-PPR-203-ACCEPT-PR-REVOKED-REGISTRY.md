...
source_audits:
  - docs/features/emit-pr-audited-revoked-registry-rehab-ppr202/validacion.md
  - .SddIA/cerbero/revoked_entities.json
canonical_title_path: docs/todos/pending/[ARQUITECTURA] accept-pr — rehabilitación revoked_entities (PPR #203).md
note_path: "Write al path canónico con corchetes fue Rejected en esta sesión; canónico por document_id"
---
...
Materialización: Cosecha Kaizen (Cúmulo) · `KAIZEN_COSECHA_GATE: APTO` · seed nueva (esta · path `PBI-PPR-203-ACCEPT-PR-REVOKED-REGISTRY.md`).
...
- [ ] Renombrar a path canónico `[ARQUITECTURA] accept-pr — rehabilitación revoked_entities (PPR #203).md` si el runtime lo permite
