...
**Veredicto global: PENDIENTE-CI.** CA locales APTO. CA-CI espera `run_id` verde del PR.
...
| KALMA-503-CA-CI | Checks GitHub Actions verdes | PENDIENTE-CI | Tras `delivery-close-cycle` |
