...
**PENDIENTE-CI** — gates locales APTO. `global: APTO` exige `run_id` verde post-PR (patrón v1.2.1). `accept-pr` vedado hasta CA-CI.
...
| CA-CI | PENDIENTE-CI | post `delivery-close-cycle` |
