...
| finalize-process | Cierre de proceso o tarea (commits, Evolution Logs, sincronización remoto, PR). Solo orquestación de skills: git-save-snapshot / invoke-commit → sddia-evolution-register si muta SddIA → git-sync-remote → git-create-pr. | paths.actionsPath/finalize-process/ |
